    ...
    <LinearGradient colors={colors.bgGradient} style={styles.gradient}>
      <KeyboardAvoidingWidget>
        <View style={styles.card}>
          <Text style={[styles.title, { color: colors.text, fontFamily: fonts.heading }]}>Giriş et</Text>
          <Text style={[styles.subtitle, { color: colors.textMuted, fontFamily: fonts.body }]}>Xərclərini izləməyə davam et</Text>
          ...
          <TouchableOpacity onPress={() => router.push('/auth/signup')}>
            <Text style={[styles.switchText]}>Hesabın yoxdur? Qeydiyyatdan keç</Text>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingWidget>
    </LinearGradient>
